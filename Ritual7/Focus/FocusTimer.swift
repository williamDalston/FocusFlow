...
/// Protocol for focus timer functionality to enable dependency injection and testing
@MainActor
protocol FocusTimerProtocol: AnyObject {
...
/// Timer implementation for Pomodoro focus/break phases with countdown functionality
@MainActor
final class FocusTimer: FocusTimerProtocol {
    // MARK: - Properties
