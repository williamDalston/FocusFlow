...
- We may use crash reporting services (if enabled)
...
We do not sell, trade, or rent your personal information to third parties. We may share anonymized, aggregated data that cannot identify you personally.

### We may share data in the following circumstances:

1. **With Your Consent**: When you explicitly allow us to share data
2. **Service Providers**: With trusted service providers who assist us in operating the app (under strict confidentiality agreements)
3. **Legal Requirements**: When required by law or to protect our rights
4. **Business Transfers**: In the event of a merger, acquisition, or sale of assets (with notification)
...
- You can disable personalized ads in iOS Settings > Privacy & Security > Apple Advertising
- You can opt out of ad tracking in the app settings (if applicable)
...
If you are using the app from outside the United States, please note that your data may be transferred to, stored, and processed in the United States. By using the app, you consent to the transfer of your data to the United States.
...
- Notifying you through the app or email (for significant changes)
...
- You can opt out of analytics in iOS Settings

### Advertising
- We may show advertisements to support free features
- Ads are provided by third-party ad networks
- We do not share personal information with advertisers
- You can control ad preferences in iOS Settings
...
- Limited access to personal data (only as necessary)
...
*This Privacy Policy is a template and should be reviewed by a legal professional before publication. Replace all bracketed placeholders with actual information.*
